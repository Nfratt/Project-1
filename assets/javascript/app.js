      ...
      function displayResultsEvents() {
          ...
          $.ajax({
              ...
              for (var i = 0; i < events.length; i++) {
                  ...
                  var pEventTickets = $('<a href=' + events[i].url + '>').addClass('btnbook btn-primary').text('Get Tickets')
      ...
      function displayResultsFood() {
          ...
          $.ajax({
              ...
              for (var i = 0; i < restaurants.length; i++) {
                  ...
                  var pRestReserve = $('<a href=' + response.restaurants[i].reserve_url + '>').addClass('btnbook').attr('id', 'reserveBtn').text('Reserve Now')
